...
const PatientSchema: Schema<IPatientDocument> = new Schema({
    ...
    familySevereDiseaseSide: { type: String, required: true },
    familySevereDiseaseMember: { type: String, required: true },
    familySevereDiseaseDetail: { type: String, required: true },
